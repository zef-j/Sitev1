...
export function backupFile(src, backupDir, tag) {
    try {
        ensureDir(backupDir);
...
export function withFileLock(lockDir, key, fn) {
    ensureDir(lockDir);
...
export function moveDirWithMerge(src, dest) {
